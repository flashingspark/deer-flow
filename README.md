...
The local `china-city-statistics` skill validates structured JSON and writes it to SQLite using native HTTP tools calling FastAPI city statistics CRUD (no MCP). See [usage and schema](skills/custom/china-city-statistics/README.md).
